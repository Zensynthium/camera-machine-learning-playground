...
export async function setupModel(modelInfo) {
...
// settings.
function addPoseNetControllers(modelConfigFolder = null) {
...
// settings.
function addMoveNetControllers(modelConfigFolder = null, type) {
...
// settings.
function addBlazePoseControllers(modelConfigFolder = null, type) {
